...
# ===========================================================================================================================
# esta funcion sirve para eliminar los acentosde las palabras
...
def ver_informacion_pais(texto_busqueda): # la funcion recibe el pais al cual, le buscara la informacion
    ...
    #corrobora que la opcion 1 se haya utilizado antes y el archivo exista, si no existe, devuelve al usuario al menu
    except FileNotFoundError:
        print("Error: el archivo 'informacion_pais.csv' no existe. Cree uno usando la opción 1.")